...
def KeyInject(civitai_key, hf_token):
    SyS(f'curl -sLo {nenen} https://github.com/ositoMalvado/sksd/raw/main/script/nenen88.py')
...
def CondaMisc():
    for scr in [
        f'curl -sLo {css} https://github.com/ositoMalvado/sksd/raw/main/script/SM/sksd.css',
