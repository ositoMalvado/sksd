...
def multi_widgets():
    ...
    x = [
        ...
        f"curl -sLo {CSS} https://github.com/ositoMalvado/sksd/raw/main/script/SM/setup.css",
        f"curl -sLo {MARK} https://github.com/ositoMalvado/sksd/raw/main/script/SM/marking.py",
        f"curl -sLo {A1111} https://github.com/ositoMalvado/sksd/raw/main/script/SM/A1111.py",
        f"curl -sLo {Forge} https://github.com/ositoMalvado/sksd/raw/main/script/SM/Forge.py",
        f"curl -sLo {ComfyUI} https://github.com/ositoMalvado/sksd/raw/main/script/SM/ComfyUI.py",
        f"curl -sLo {ReForge} https://github.com/ositoMalvado/sksd/raw/main/script/SM/ReForge.py",
        f"curl -sLo {FaceFusion} https://github.com/ositoMalvado/sksd/raw/main/script/SM/FaceFusion.py",
        f"curl -sLo {SDTrainer} https://github.com/ositoMalvado/sksd/raw/main/script/SM/SDTrainer.py"
    ]
