...
def CN_Script(WEBUI):
    return f'https://github.com/ositoMalvado/sksd/raw/main/script/controlnet.py {WEBUI}/asd'
...
def Segsmaker_Setup_Widgets():
    for cmd in [
        ...
        f'curl -sLo {IMG} https://github.com/ositoMalvado/sksd/raw/main/script/loading.apng',
        f'curl -sLo {MRK} https://github.com/ositoMalvado/sksd/raw/main/script/marking.py'
    ]: SyS(cmd)
