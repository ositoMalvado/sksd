...
def webui_req(U, W, M):
    ...
    scripts = [
        ...
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/venv.py {W}",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/Launcher.py {W}",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/sksd.py {W}"
    ]
...
def facetrainer(ui):
    ...
    with output:
        ...
        scripts = [
            f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/venv.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/Launcher.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/sksd.py {WEBUI}"
        ]
        ...
        if git_dir.exists():
            ...
            with output:
                ...
                if ui not in ['SDTrainer', 'FaceFusion']:
                    x.append(f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/controlnet.py {WEBUI}/asd")
...
def multi_widgets():
    for cmd in [
        ...
        f'curl -sLo {MRK} https://github.com/ositoMalvado/sksd/raw/main/script/SM/marking.py'
    ]: SyS(cmd)
