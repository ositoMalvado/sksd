...
def controlnet_widgets():
    x = [
        f"curl -sLo {cn15} https://github.com/ositoMalvado/sksd/raw/main/script/SM/cn-15.py",
        f"curl -sLo {cnxl} https://github.com/ositoMalvado/sksd/raw/main/script/SM/cn-xl.py",
        f"curl -sLo {css_cn} https://github.com/ositoMalvado/sksd/raw/main/script/SM/controlnet.css"]
    for y in x:
