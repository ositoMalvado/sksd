...
def webui_req():
    ...
    scripts = [
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/controlnet.py {WEBUI}/asd",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/venv.py {WEBUI}",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/multi/sksd.py {WEBUI}"]
...
def webui_widgets():
    if WEBUI.exists():
        ...
        x = [
            f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/controlnet.py {WEBUI}/asd",
            f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/venv.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/config/comfyui/apotek.py {WEBUI}",
            f"https://github.com/ositoMalvado/sksd/raw/main/config/comfyui/launch.py {WEBUI}",
