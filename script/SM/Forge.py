...
def webui_req():
    ...
    scripts = [
        ...
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/zrok.py {WEBUI}",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/pinggy.py {WEBUI}",
        f"https://github.com/ositoMalvado/sksd/raw/main/script/SM/ngrokk.py {WEBUI}",
