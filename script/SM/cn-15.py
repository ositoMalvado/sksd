...
select_all_button = widgets.Button(description="Todo", layout=widgets.Layout(width='130px', left='15px'))
unselect_all_button = widgets.Button(description="Nada", layout=widgets.Layout(width='130px', left='20px'))
