...
IMG = 'https://github.com/ositoMalvado/sksd/raw/main/script/loading.apng'
...
def PythonPortable():
    ...
    CD('/')
    print(f'\n{AR} Instalando Python Portable 3.10.15')
...
def webui_req(U, W, M):
    ...
    scripts = [
        f'https://github.com/ositoMalvado/sksd/raw/main/script/controlnet.py {W}/asd',
...
def notebook_scripts():
    z = [
        ...
        (nenen, f'wget -qO {nenen} https://github.com/ositoMalvado/sksd/raw/main/script/nenen88.py'),
        (STR / 'cupang.py', f'wget -qO {STR}/cupang.py https://github.com/ositoMalvado/sksd/raw/main/script/cupang.py'),
        (MRK, f'wget -qO {MRK} https://github.com/ositoMalvado/sksd/raw/main/script/marking.py')
    ]
