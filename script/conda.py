...
civitai_key_box = widgets.Text(placeholder='Ingresa Tu Civitai API KEY Aquí', layout=widgets.Layout(width='350px'))
...
def conda_install():
    try:
        ...
        clear_output()
        print(f"{GREEN} Listo. Instalación completa. Ejecuta 2 veces esta celda la priemra vez. No hace falta reiniciar el entorno como dice la alerta")
